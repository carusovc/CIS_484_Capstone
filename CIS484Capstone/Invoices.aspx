...
<div class="row table-responsive mx-auto d-flex  justify-content-center">
    ...
    HeaderStyle-Forecolor="#732700" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" DataKeyNames="PaymentID"  
...
<HeaderStyle BackColor="#FFBC7C" ForeColor="#732700"></HeaderStyle>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WildTekConnectionString %>"
                                            SelectCommand="SELECT convert(varchar, PaymentDate,101) as PaymentDate,[PaymentAmount], [CheckNumber],  [PaymentType], ProgramName, [OrgName],Program.PaymentID as PaymentID,[Invoice], Paid
