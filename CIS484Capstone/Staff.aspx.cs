...
public partial class Volunteers : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (con.State == System.Data.ConnectionState.Open)
            {
                ...
                while (myRead2.Read())
                {
                    ...
                    ddlEducatorName.Items.Add(new ListItem(myRead2["FirstName"].ToString(), (myRead2["UserID"].ToString())));
    ...
    protected void ddlEducator_SelectedIndexChanged1(object sender, EventArgs e)
    {
        ...
        //insert.CommandText = "select FirstName, LastName, lastUpdated, lastUpdatedBy, status from Educators where educatorID = @educatorID";

        insert.Parameters.AddWithValue("@userID", ddlEducatorName.SelectedItem.Value);
