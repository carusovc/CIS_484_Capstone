...
<table class="table table-condensed table-borderless table-hover" style="border-collapse:collapse;"> --%>
                                ...
                                <div class="col-lg-8 col-md-12 col-s-12 mx-auto" id=" accordion2">
                                    <div class="container1 block">
                                        ...
                                        <div class="tab-content">
                                            <div id="home" class="container1 block tab-pane active">
                                                <br>
                                                <table class="table table-condensed table-borderless table-hover" style="border-collapse: collapse;" id="testtable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td colspan="6" class="hiddenRow">
                                                                <div class="accordian-body collapse" id="OnlineProgram1">
                                                                    <%--<div>
                                                        ...
                                                        <tr>
                                                            <td colspan="6" class="hiddenRow">
                                                                <div id="OnlineProgram2" class="accordian-body collapse">
                                            ...
                                            <div id="menu1" class="container1 block tab-pane fade">
                                                <br>
                                                <table class="table table-condensed table-borderless table-hover" style="border-collapse: collapse;">
                                                    ...
                                                    <tbody id="ProgramTable">
                                                        ...
                                                        <tr>
                                                            <td colspan="6" class="hiddenRow">
                                                                <div class="accordian-body collapse" id="Program1">
                                                                    <div>
                    ...
                    <span aria-hidden="true">×</span>
                                                                            ...
                                                                            <div class=" p-4" id="resultProgram">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-6 ProgramInfoPop">
                                                                                        ...
                                                                                        <h6 class="ProgramDescription" id="OrgName">James Madison University</h6>
                                                                                    </div>

                                                                                    <div class=" col-md-6 ProgramInfoPop">
                                                                                        <h4>Status:</h4>
                                                                                        <h6 class="ProgramDescription" id="ProgramStatus">Completed</h6>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-5 ProgramInfoPop">
                                                                                        ...
                                                                                        <h6 class="ProgramDescription" id="ProgramAddress">800 S Main, Harrisonburg, VA, 22801</h6>
                                                                                    </div>
                                                                                    <div class="col-md-3 ProgramInfoPop">
                                                                                        <h4>City:</h4>
                                                                                        <h6 class="ProgramDescription" id="Programcity">Harrisonburg</h6>
                                                                                    </div>

                                                                                    <div class="col-md-4 ProgramInfoPop">
                                                                                        <h4>County:</h4>
                                                                                        <h6 class="ProgramDescription" id="ProgramCounty">Rockingham County</h6>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-3 ProgramInfoPop">
                                                                                        <h4>Date:</h4>
                                                                                        <h6 class="ProgramDescription" id="ProgramDate">10/14/18</h6>
                                                                                    </div>


                                                                                    <div class="col-md-4 ProgramInfoPop">
                                                                                        <h4>Start Time:</h4>
                                                                                        <h6 class="ProgramDescription" id="ProgramTime">3:00 pm</h6>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-2 ProgramInfoPop">
                                                                                        <h4>Grade</h4>
                                                                                        <h6 class="ProgramDescription" id="ProgramGrade">3rd</h6>
                                                                                    </div>

                                                                                    <div class="col-md-3 ProgramInfoPop">
                                                                                        <h4>Educators</h4>
                                                                                        <h6 class="ProgramDescription" id="ProgramEd">Raina, Alex</h6>
                                                                                    </div>


                                                                                    <div class="col-md-3 ProgramInfoPop">
                                                                                        <h4># of Adults:</h4>
                                                                                        <h6 class="ProgramDescription" id="ProgramAdults">4</h6>
                                                                                    </div>


                                                                                    <div class="col-md-3 ProgramInfoPop">
                                                                                        <h4># of Children:</h4>
                                                                                        <h6 class="ProgramDescription" id="ProgramChild">26</h6>
                                                                                    </div>
                                                        ...
                                                        <tr>
                                                            <td colspan="6" class="hiddenRow">
                                                                <div id="Program2" class="accordian-body collapse">
