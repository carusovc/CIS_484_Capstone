<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AdminLogin-TO BE DELETED - DON'T USE.aspx.cs" Inherits="AdminLogin" %>
...
<section class="login-block">
  ...
  <div class="form-group">
    ...
    <%--<input class="input-md emailinput form-control" id="txtUsername" name="email" placeholder="Email address" style="margin-bottom: 10px" type="email" runat="server"/>--%>
      ...
      <asp:TextBox ID="txtUsername" class="input-md emailinput form-control" placeholder="Email address" style="margin-bottom: 10px" type="text" runat="server"></asp:TextBox>
