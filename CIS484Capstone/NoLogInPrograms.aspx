...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <a class="navbar-brand logo" href="Default.aspx">< Back to Login</a>
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div class="block justify-content-center table-responsive">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="mx-auto d-flex justify-content-center  col-lg-3    col-md-4 col-sm-6 ">
                                                            <asp:Button ID="btnExportLive" runat="server" Text="Export to Excel" class="btn btn-primary btn-inside btn-block" Visible="false"></asp:Button>
                                            ...
                                            <div id="OnlineTab" class="tab-pane fade in ">
                                                ...
                                                <div class="block justify-content-center table-responsive">
                                                    ...
                                                    <div class="row">
                                                        <div class="mx-auto d-flex justify-content-center  col-lg-3    col-md-4 col-sm-6 ">
                                                            <asp:Button ID="btnExportOnline" runat="server" Text="Export to Excel" class="btn btn-primary btn-inside btn-block" Visible="false"></asp:Button>
