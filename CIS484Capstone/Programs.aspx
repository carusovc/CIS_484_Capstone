                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="AllTab" class="tab-pane show active">
                                                ...
                                                <div class="row mx-auto justify-content-center d-flex">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-xs-12 ">
<%--                                                        <asp:Button ID="btnAllSearch1" runat="server" class="btn  " Style=" background-color: #FFBC7C; margin-right: 5px; margin-bottom: 5px;" Text="Search" OnClick="btnAllSearch_Click"  /> --%>
                                            ...
                                            <div id="LiveTab" class="tab-pane fade in">
                                                ...
                                                <div class="row mx-auto justify-content-center d-flex">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-xs-12 ">
                                                        ...
                                                        <asp:Button ID="btnLiveSearch1" runat="server" class="btn" Style=" background-color: #FFBC7C; margin-right: 5px; margin-bottom: 5px;" Text="Search" OnClick="btnLiveSearch_Click" />
                                                        <asp:Button ID="btnLiveClear1" runat="server" class="btn" Style="margin-bottom: 5px;" Text="Clear Filters" OnClick="btnLiveClear_Click" />
                                                        <br />
