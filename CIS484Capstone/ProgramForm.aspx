...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WildlifeCenterConnectionString2 %>" SelectCommand="SELECT * FROM [ProgramType]"></asp:SqlDataSource>
