<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.master" AutoEventWireup="true" CodeFile="TabLiveReports.aspx.cs" Inherits="Tableau4" %>
...
<br />
 ...
 <asp:Button ID="Button1" runat="server" Text="Back" class="btn btn-primary btn-login btn-block" OnClick="btnBack_Click"></asp:Button>
               </div>
                <br />
            </div>
